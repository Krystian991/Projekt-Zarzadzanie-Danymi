...
<div class="container-sm">
	<div class="row align-items-start">
		<div class="col moje">
		<form action="/ZmienUprawnienia.php" id="test" method="post" enctype="multipart/form-data">
	...
	<label for="rola">Wybierz uprawnienia:</label>
	<select id="rola" name="rola" form="test">
