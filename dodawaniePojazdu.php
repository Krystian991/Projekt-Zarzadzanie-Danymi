...
<form action="dodajpojazd.php" method="post" enctype="multipart/form-data">
	<div class="row">
		<div class="col">
		<input type="text" class="form-control" placeholder="Marka Pojazdu" id="Marka" name="Marka" aria-label="Marka" required>
		</div>
	...
	<div class="row">
		<div class="col">
		<input type="text" class="form-control" placeholder="Nr Vin" id="Vin" name="Vin" aria-label="Vin" required>
		</div>
	...
	<div class="row">
		<div class="col">
		<input type="text" class="form-control" placeholder="Nr Rejestracyjny" id="nrRej" name="nrRej" aria-label="nrRej" required>
		</div>
